const loichuc = [
  {
    ...
    desc: "Nhân dịp Giáng sinh và năm mới sắp đến, mình muốn gửi đến Vân Nhi những lời chúc tốt đẹp nhất từ tận đáy lòng. Mong rằng mùa Giáng sinh này sẽ mang đến cho bạn thật nhiều sự ấm áp, bình an và yêu thương. Chúc bạn luôn giữ được nụ cười rạng rỡ, tinh thần tích cực và gặp thật nhiều điều tốt đẹp trong cuộc sống. Dù ở đâu và làm gì, hy vọng bạn luôn cảm thấy hạnh phúc và được trân trọng 💖",
